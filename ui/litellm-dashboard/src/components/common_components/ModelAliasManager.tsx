...
const ModelAliasManager: React.FC<ModelAliasManagerProps> = ({
  ...
  const handleAddAlias = () => {
    if (!newAlias.aliasName || !newAlias.targetModel) {
      NotificationsManager.fromBackend(t("Please provide both alias name and target model"));
      return;
    }
    ...
    <div className="mt-4">
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">{t("Target Model")}</label>
            <ModelSelector
          ...
          <Table className="[&_td]:py-0.5 [&_th]:py-1">
            <TableHead>
              <TableRow>
                ...
                <TableHeaderCell className="py-1 h-8">{t("Target Model")}</TableHeaderCell>
      ...
      {showExampleConfig && (
        <Card>
          ...
          <Text className="text-gray-600 mb-4">{t("Here's how your current aliases would look in the config:")}</Text>

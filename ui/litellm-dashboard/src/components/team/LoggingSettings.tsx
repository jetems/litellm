          ...
          {Object.entries(dynamicParams).map(([paramName, paramType]) => (
            <div key={paramName} className="space-y-2">
              <label className="text-sm font-medium text-gray-700 capitalize flex items-center space-x-1">
                ...
                <Tooltip title={`${t("Environment variable reference recommended")}: os.environ/${paramName.toUpperCase()}`}>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          ...
          <Tooltip title={t("Select callbacks to disable for this key. Disabled callbacks will not receive any logging data.")}>
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-gray-500">
            {t("Select callbacks that should be disabled for this key. These callbacks will not receive any logging data.")}
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">{callbackDisplayName || t("New Integration")} {t("Configuration")}</span>
                </div>
                <Button
                  variant="light"

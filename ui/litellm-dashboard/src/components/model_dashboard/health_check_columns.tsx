...
export const healthCheckColumns = (
  ...
  // Create a default translate function if none provided
  ...
  return [
    ...
    {
      header: translate("Health Status"),
        ...
        if (healthStatus.loading) {
          return (
            <div className="flex items-center space-x-2">
              ...
              <Text className="text-gray-600 text-sm">{translate("Checking...")}</Text>
            </div>
          );
        }
        ...
        return (
          <div className="flex items-center space-x-2">
            ...
            {hasSuccessResponse && showSuccessModal && (
              <Tooltip title={translate("View response details")} placement="top">
                <button
    ...
    {
      header: translate("Error Details"),
      ...
      cell: ({ row }) => {
        ...
        if (!healthStatus?.error) {
          return <Text className="text-gray-400 text-sm">{translate("No errors")}</Text>;
        }
        ...
        return (
          <div className="flex items-center space-x-2">
            ...
            {showErrorModal && fullError !== cleanedError && (
              <Tooltip title={translate("View full error details")} placement="top">
                <button
      ...
      cell: ({ row }) => {
        ...
        return (
          <Text className="text-gray-600 text-sm">
            {model.health_loading ? translate("Check in progress...") : model.last_check}
          </Text>
        );
      },
    },
    {
      header: translate("Last Success"),
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const tooltipText = model.health_loading
          ? translate("Checking...")
          : hasExistingStatus
            ? translate("Re-run Health Check")
            : translate("Run Health Check");

        return (
          <Tooltip title={tooltipText} placement="top">
            <button
              className={`p-2 rounded-md transition-colors ${model.health_loading

    ...
    <Card className="p-3">
      <div className="mb-2">
        ...
        <Text className="text-gray-500 text-xs mt-1">
          {t("Use")} <code className="bg-gray-100 px-1 rounded text-xs">{'{{variable}}'}</code> {t("syntax for template variables")}
        </Text>
      </div>
      <div className="space-y-2">
        {messages.map((message, index) => (
          <div
            ...
            className={`border border-gray-300 rounded overflow-hidden bg-white transition-all ${draggedIndex === index ? "opacity-50" : ""

      ...
      <Accordion className="mt-2 mb-4">
        ...
        <AccordionBody>
          <div className="bg-white rounded-lg">
            <Form.Item label={t("Custom Pricing")} name="custom_pricing" valuePropName="checked" className="mb-4">
            ...
            <Form.Item
              ...
              name="guardrails"
              className="mt-4"
              help={t("Select existing guardrails. Go to 'Guardrails' tab to create new guardrails.")}
            >
              <Select
                mode="tags"
                style={{ width: "100%" }}
            ...
            {customPricing && (
              <div className="ml-6 pl-4 border-l-2 border-gray-200">
                <Form.Item label={t("Pricing Model")} name="pricing_model" className="mb-4">
                  <Select
            ...
            <Form.Item
              ...
              tooltip={
                <span>
                  {t("Allow using these credentials in pass through routes.")}{" "}
            ...
            <Row className="mb-4">
              ...
              <Col span={10}>
                <Text className="text-gray-600 text-sm">
                  {t("Pass JSON of litellm supported params")}{" "}

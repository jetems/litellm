            ...
            {isTeamAdmin && !isAdmin && (
              <>
                <Form.Item
                  label={t("Select Team")}
                  name="team_id"
                  rules={[{ required: true, message: t("Please select a team to continue") }]}
                  tooltip={t("Select the team for which you want to add this model")}
                >
                  <TeamDropdown
                    teams={teams}
                    onChange={(value) => {
                ...
                {!teamAdminSelectedTeam && (
                  <Alert
                    message={t("Team Selection Required")}
                    description={t("As a team admin, you need to select your team first before adding models.")}
                    type="info"
                    showIcon
                    className="mb-4"
                  />

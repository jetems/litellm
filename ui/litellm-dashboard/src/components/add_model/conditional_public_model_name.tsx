  ...
  const publicNameTooltipContent = (
    <>
      ...
      <div className="mb-2 font-normal">
        ...
        <code className="bg-gray-700 px-1 py-0.5 rounded text-xs">example-name</code>{t(", and choose")}{" "}
        <code className="bg-gray-700 px-1 py-0.5 rounded text-xs">openai/qwen-plus-latest</code> {t("as the LiteLLM model")}
      </div>
      <div className="mb-2 font-normal">
      ...
      <div className="font-normal">
        ...
        <code className="bg-gray-700 px-1 py-0.5 rounded text-xs">qwen-plus-latest</code> {t("to the provider")}
      </div>
    </>
  );
